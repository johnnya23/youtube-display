...
class JMAYtSettings
{
    ...
    {
        wp_enqueue_style('eyecon_style', plugin_dir_url(__FILE__) . 'colorpicker.css');
        wp_register_script('eyecon_script', plugin_dir_url(__FILE__) . 'colorpicker.js');

        // We're including the WP media scripts here because they're needed for the image upload field
        // If you're not including an image upload then you can leave this function call out
        wp_enqueue_media();

        wp_register_script($this->settings_base . 'admin-js', $this->assets_url . 'settings.js', array( 'eyecon_script', 'jquery' ), '1.0.0');
